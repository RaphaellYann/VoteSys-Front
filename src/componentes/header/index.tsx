...
const Header = () => {
  ...
  // OBS: O uso de "as any" abaixo é para corrigir o erro TS2322 durante o build
  return (
      ...
      <Container fluid="xl">
        ...
        <Navbar.Collapse id="nav-bar">
          <Nav className="me-auto gap-2">
            <Nav.Link as={NavLink as any} to="/" end>
            ...
            {isAutenticado && (
              <>
                {canAccessCampaigns && (
                  <Nav.Link as={NavLink as any} to="/campanha">
                    <ArchiveFill className="me-1" /> Campanhas
                  </Nav.Link>
                )}

                <Nav.Link as={NavLink as any} to="/votacao">
                  <CardChecklist className="me-1" /> Votações
                </Nav.Link>

                <Nav.Link as={NavLink as any} to="/resultados">
                  <BarChartLineFill className="me-1" /> Resultados
                </Nav.Link>

                {isGeneralAdmin && (
                  <Nav.Link as={NavLink as any} to="/usuarioAdmin">
